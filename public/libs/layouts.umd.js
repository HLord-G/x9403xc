(function(T, L) {
  typeof exports == "object" && typeof module < "u" ? module.exports = L() : typeof define == "function" && define.amd ? define(L) : (T = typeof globalThis < "u" ? globalThis : T || self,
  T.StudioSdkPlugins_flexComponent = L())
}
)(this, function() {
  "use strict";
  const T = "app.grapesjs.com"
    , L = "app-stage.grapesjs.com"
    ...
    , be = "license:check:end"
    , Ce = () => typeof window < "u"
    , Pe = ({isDev: n, isStage: e}) => `${n ? "" : `${e ? L : T}`}/api`
    , ze = () => {
  ...
  async function Re({editor: n, plan: e, pluginName: t, licenseKey: s, cleanup: i}) {
      ...
      const l = ze()
        , c = p => {
          console.warn("Cleanup plugin:", t, "Reason:", p),
          i()
      }
        , f = (p={}) => {
          var S;
          const {error: u, sdkLicense: g} = p
            , v = (S = p.plan) == null ? void 0 : S.category;
          if (!(g || p.license) || u)
              c(u || "Invalid license");
          else if (v) {
              const I = ce[e]
  ...
  async function Ee(n) {
      ...
      try {
          ...
          return console.error("Error during SDK license check:", i),
          !1
      }
  }
  const le = n => e => {
    ...
    , Ge = (...n) => e => n.some(t => e.is(t))
    , Te = (...n) => (e, t) => n.some(s => t.is(s))
    , pe = "gjs-plg-"
    , J = "data-type-role"
    , B = class B {
      constructor(e) {
  ...
  const U = class U {
      ...
      getParentSize(e) {
          var a;
          if ((a = this.config) != null && a.getParentSize)
              return this.config.getParentSize(e);
          const {componentRow: t, isVertical: s} = e
            , i = t.getEl();
          return i ? s ? i.clientHeight : i.clientWidth : 0
      }
      isLayoutVertical(e) {
          var s;
          if ((s = this.config) != null && s.isParentVertical)
              return this.config.isParentVertical(e);
  ...
  const k = class k {
      ...
      getSize(e) {
          var s;
          if ((s = this.config) != null && s.getSize)
              return this.config.getSize(e);
      ...
      setSize(e) {
          ...
          if ((t = this.config) != null && t.setSize)
              ...
              const {componentColumn: s, sizeValue: i, partial: a} = e;
              s.is(k.MJML_COLUMN_TYPE) && s.addAttributes({
                  width: `${parseFloat(i)}%`
              }, {
                  partial: a
              })
  ...
  const W = class W {
      ...
      getGap(e) {
          var s;
          if ((s = this.config) != null && s.getGap)
              return this.config.getGap(e);
  ...
  class Le {
      ...
      getParentSize(e) {
          var o;
          if ((o = this.config) != null && o.getParentSize)
              return this.config.getParentSize(e);
          const {componentRow: t, isVertical: s} = e
            , i = t.getEl();
          if (!i)
  ...
  class H {
      ...
      static getInstance() {
          return H.instance || (H.instance = new H),
          H.instance
      }
      getHandlers(e) {
  ...
  const de = n => {
    ...
    , j = n => +parseFloat(`${n}`).toFixed(2)
    , A = n => n.projectType === re.email
    , O = (n, e) => {
    ...
    , X = n => n === "top" || n === "bottom"
    , je = (n, e) => !!(He(n) && (e === "left" || e === "top") || Ae(n) && (e === "right" || e === "bottom"))
    , Ne = n => {
      const e = n.parent();
      return e ? e.components().models.length > 1 : !1
  }
    , he = (n, e) => n === "right" || n === "bottom" ? e > 0 : e < 0
    , ne = (n, e, t=!1) => {
      const s = !t
        , i = n.getEl();
      if (!i)
      ...
      if (s) {
          let l;
          return typeof o == "string" ? (l = parseFloat(o.replace(/[^-\d.]/g, "")),
          isNaN(l) && (l = 0)) : l = Number(o) || 0,
          l
      }
      return o
  }
    , fe = (n, e, t) => {
      const s = se({
        ...
        , i = n.components().models;
      return s * (i.length - 1)
  }
    , N = (n, e) => G(e).parentSizeHandler.isLayoutVertical({
      componentRow: n
  })
    , _ = (n, e) => G(e).sizeHandler.getSize(n)
    , se = (n, e) => {
      if (e != null && e.disableGapHandler)
          return 0;
    ...
    , ie = (n, e) => G(e).parentSizeHandler.getParentSize(n)
    , F = (n, e) => {
  ...
  function Fe(n, e) {
      const {Blocks: t} = n
        , {typeColumn: s, typeRow: i, blocks: a} = e;
      if (a === !1 || A(e))
          return;
      const o = u => ({
          type: i,
    ...
    ${u.map(g => `<div style="flex-basis: ${g}%; border-color: currentColor; border-width: 2px; border-radius: 0.12rem;"></div>`).join("")}
        ...
        , c = (u, g) => ({
          ...
          full: !0,
          attributes: {
              class: "gs-block-item__flex gs-utl-w-full"
          },
          media: l(g),
          content: o(g)
      })
  ...
  const Be = (n, e) => {
      const {Components: t} = n
        , {typeRow: s, typeColumn: i, extendTypeColumn: a} = e
        , o = `${pe}${i}`
        , c = !!i && !!t.getType(i) && !a;
      if (!(!i || c || A(e)))
          return t.addType(i, {
    ...
    , De = (n, e) => {
      const {Components: t} = n
        , {typeRow: s, typeColumn: i, extendTypeRow: a} = e
        , o = `${pe}${s}`
        , c = !!s && !!t.getType(s) && !a;
      if (!(!s || c || A(e)))
          return t.addType(s, {
  ...
  class ke {
      constructor() {
          this.resizableChildTypes = new Set,
          this.gapAdjustableParentTypes = new Set,
          this.typeRelationships = new Map
      }
      ...
      registerTypeRelationship(e, t) {
          this.typeRelationships.has(e) || this.typeRelationships.set(e, new Set),
          this.typeRelationships.get(e).add(t),
          this.registerResizableChild(t),
          this.registerGapAdjustableParent(e)
      }
      isResizableChild(e) {
  ...
  class Oe {
      constructor(e, t, s) {
          ...
          this.registry = t,
          this.opts = s,
          this.resizeState = new WeakMap
      }
      getState(e) {
          return this.resizeState.has(e) || this.resizeState.set(e, {}),
          this.resizeState.get(e)
      }
      clearState(e) {
      ...
      startResize(e, t, s) {
          ...
          a.startY = s.clientY,
          a.resizing = !0,
          a.lastSnappedPercent = void 0;
          const o = e.parent();
          if (!o || !this.registry.isValidRelationship(o, e))
              return;
          a.snapEnabled = o.get("snap") ?? i.snapEnabled,
          a.snapDivisions = o.get("snap-divisions") ?? i.snapDivisions ?? 12;
          const l = o.components().models
            , c = l.findIndex(g => g.cid === e.cid)
            , f = N(o, i)
            , p = Me(c, t, f, l.length);
          p !== -1 && (a.adjacentIdx = p);
          const u = {
          ...
          if (a.startPercent = _(u, i),
          typeof a.adjacentIdx < "u") {
              const g = l[a.adjacentIdx];
              a.neighborStartPercent = _({
                  ...u,
                  componentColumn: g
              }, i)
          }
      ...
      finishResize(e) {
          const t = e.parent()
            , s = t == null ? void 0 : t.components().models
            , i = {
              componentRow: t,
              isVertical: !!t && N(t, this.opts)
          };
          s == null || s.forEach(a => ge({
              ...i,
              componentColumn: a
          }, this.opts)),
          this.clearState(e)
      ...
      updateContinuesResize(e, t, s) {
          ...
          const l = o.minItemPercent ?? 0
            ...
            , g = 100 - p / f * 100
            , v = s / (f - p) * g
            , {startPercent: P=0, neighborStartPercent: S=0} = i
            , I = {
              componentRow: a,
              isVertical: c,
              componentColumn: e,
          ...
          if (typeof i.adjacentIdx < "u") {
              const z = a.components().models[i.adjacentIdx]
                , x = P + S
                , b = x - l
                , r = Math.min(b, Math.max(l, R))
                , d = x - r;
              F({
                  ...I,
                  sizeValue: `${j(r)}%`
      ...
      updateSnapResize(e, t, s) {
          const i = this.getState(e)
            ...
            , p = s / f * 100
            , u = he(t, s)
            , {startPercent: g=0, snapDivisions: v=12} = i
            , P = u ? g + Math.abs(p) : g - Math.abs(p)
            , S = 100 / v
            , I = Math.floor(P / S) * S
            , R = Math.ceil(P / S) * S
            , z = Math.abs(R - P)
          ...
          if (C > 0 && C < 100 && (z < b || x < b) && i.lastSnappedPercent !== C) {
              ...
              (u && (t === "left" || t === "top") || !u && (t === "right" || t === "bottom")) && (m = -m),
              this.updateContinuesResize(e, t, m)
          } else
              z >= b && x >= b && (i.lastSnappedPercent = void 0)
      }
  }
  class Xe {
      constructor(e, t, s) {
      ...
      updateGapByDelta(e, t, s, i) {
          if (!this.registry.isGapAdjustableParent(e))
              return;
          const {opts: a} = this
            , o = Math.max(0, s + t)
            , l = ie({
  ...
  class Ye {
      constructor(e, t, s) {
          ...
          this.registry = t,
          this.opts = s,
          this.resizeHandler = new Oe(e,t,s),
          this.gapHandler = new Xe(e,t,s)
      }
      startResize(e, t, s) {
  ...
  function We(n, e) {
      ...
      const p = new ke
        ...
        , g = () => {
          ...
          Object.entries(o).forEach( ([d,m]) => {
              const y = d
                , h = X(y);
              m.className = `${ye} ${ye}-${y} gjs-resizer-h gjs-cv-unscale`,
              m.style.cssText = `
      pointer-events: all;
      position: absolute;
      z-index: 1;
      ...
      ${y === "bottom" ? "bottom: 0px;" : ""}
    `,
              m.addEventListener("pointerdown", v(y)),
              a.appendChild(m)
          }
          ),
          !e.disableGapHandler && !A(e) && (l = document.createElement("div"),
          l.className = Ue,
          l.style.cssText = `
      position: absolute;
    ...
    `,
          ...
          a.appendChild(l)),
          i.append(a),
          (r = t.getSpotsEl()) == null || r.appendChild(i)
      }
        , v = r => d => {
          if (!c)
              return;
          ...
          const h = V => {
              const E = n.Canvas.getZoomMultiplier()
                , M = (V.clientX - m) * E
                , K = (V.clientY - y) * E
                , ae = X(r) ? K : M;
        ...
        , P = () => r => {
          ...
          const V = M => {
              const K = n.Canvas.getZoomMultiplier()
                , ae = m ? (M.clientY - w) * K : (M.clientX - h) * K;
              u.updateGapByDelta(d, ae, y, m)
          }
            , E = () => {
              O(n, !1),
              u.finishGapAdjust(d),
        ...
        , I = (r, d, m=!1) => {
          const y = e.gapHandleSize
            , h = l.style;
          if (d) {
              h.height = `${y}px`;
              const w = l.offsetHeight;
              m ? (h.top = `-${(r + w) / 2}px`,
              h.bottom = "") : (h.bottom = `-${(r + w) / 2}px`,
              h.top = ""),
              h.width = "50%",
              h.left = "50%",
              ...
              m ? (h.left = `-${(r + w) / 2}px`,
              h.right = "") : (h.right = `-${(r + w) / 2}px`,
              h.left = ""),
              h.height = "50%",
              h.top = "50%",
              h.transform = "translateY(-50%)",
              h.cursor = "col-resize"
          }
      }
        , R = () => {
        ...
        , z = () => {
          ...
          const r = n.getSelected()
            , d = r == null ? void 0 : r.parent();
          r && d && p.isValidRelationship(d, r) ? t.addSpot({
              type: s,
              component: r
          }) : R()
      }
      ...
      n.onReady( () => {
          g(),
          A(e) ? b("mj-section", "mj-column") : b(e.typeRow, e.typeColumn)
      }
      );
      const C = "component:toggled";
      return n.on(t.events.spot, x),
      n.on(C, z),
      () => {
          n.off(t.events.spot, x),
          n.off(C, z)
      }
  }
  const Ke = "flexComponent";
