(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))x(t);new MutationObserver(t=>{for(const i of t)if(i.type==="childList")for(const p of i.addedNodes)p.tagName==="LINK"&&p.rel==="modulepreload"&&x(p)}).observe(document,{childList:!0,subtree:!0});function o(t){const i={};return t.integrity&&(i.integrity=t.integrity),t.referrerPolicy&&(i.referrerPolicy=t.referrerPolicy),t.crossOrigin==="use-credentials"?i.credentials="include":t.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function x(t){if(t.ep)return;t.ep=!0;const i=o(t);fetch(t.href,i)}})();const u=()=>[{id:"section-1",label:"Section A",category:"section",media:`<svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor" class="bi bi-union" viewBox="0 0 16 16">
  <path d="M0 2a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v2h2a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2v-2H2a2 2 0 0 1-2-2z"/>
</svg>`,content:`<section id="section_041725_a" class="min-h-[80px] flex fex-row w-full max-[919px]:flex-col">
    ...
    </section>`},{id:"section-3_b",label:"Section - B",category:"section",media:`<svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor" class="bi bi-union" viewBox="0 0 16 16">
  <path d="M0 2a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v2h2a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2v-2H2a2 2 0 0 1-2-2z"/>
</svg>`,content:`<section id="sections_041825_b" class="min-h-[100vh] flex flex-col w-full relative p-[7px]">
    ...
    </section>`},{id:"section-4_c",label:"Section - C",category:"section",media:`
<svg xmlns="http://www.w3.org/2000/svg" height="45" viewBox="0 -960 960 960" width="45" fill="currentColor"><path d="M200-520q-33 0-56.5-23.5T120-600v-160q0-33 23.5-56.5T200-840h560q33 0 56.5 23.5T840-760v160q0 33-23.5 56.5T760-520H200Zm0-80h560v-160H200v160Zm0 480q-33 0-56.5-23.5T120-200v-160q0-33 23.5-56.5T200-440h560q33 0 56.5 23.5T840-360v160q0 33-23.5 56.5T760-120H200Zm0-80h560v-160H200v160Zm0-400v-160 160Zm0 400v-160 160Z"/></svg>`,content:`<section id="sections_041825_c" class="flex flex-row min-h-screen relative max-[769px]:flex-col">
    ...
    </section>`},{id:"section-5_d",label:"Section - D",category:"section",media:`
<svg xmlns="http://www.w3.org/2000/svg" height="45" viewBox="0 -960 960 960" width="45" fill="currentColor"><path d="M200-520q-33 0-56.5-23.5T120-600v-160q0-33 23.5-56.5T200-840h560q33 0 56.5 23.5T840-760v160q0 33-23.5 56.5T760-520H200Zm0-80h560v-160H200v160Zm0 480q-33 0-56.5-23.5T120-200v-160q0-33 23.5-56.5T200-440h560q33 0 56.5 23.5T840-360v160q0 33-23.5 56.5T760-120H200Zm0-80h560v-160H200v160Zm0-400v-160 160Zm0 400v-160 160Z"/></svg>`,content:`<section id="sections_041825_d" class="flex flex-rcol relative justify-center items-center min-h-[30vh] p-[20px] relative before:contentcontent-[' '] before:absolute before:top-0 before:left-0 before:bg-[#ccfe00] before:p-[20px] before:h-full before:w-[20%]">
    ...
    </section>`},{id:"section-6_e",label:"Section - E",category:"section",media:`
<svg xmlns="http://www.w3.org/2000/svg" height="45" viewBox="0 -960 960 960" width="45" fill="currentColor"><path d="M200-520q-33 0-56.5-23.5T120-600v-160q0-33 23.5-56.5T200-840h560q33 0 56.5 23.5T840-760v160q0 33-23.5 56.5T760-520H200Zm0-80h560v-160H200v160Zm0 480q-33 0-56.5-23.5T120-200v-160q0-33 23.5-56.5T200-440h560q33 0 56.5 23.5T840-360v160q0 33-23.5 56.5T760-120H200Zm0-80h560v-160H200v160Zm0-400v-160 160Zm0 400v-160 160Z"/></svg>`,content:`<section id="sections_041825_e" class="flex flex-col relative justify-center items-center min-h-[100vh] relative">
    ...
    </section>`},{id:"section_042125_f",label:"section - f",category:"section",media:`
<svg xmlns="http://www.w3.org/2000/svg" height="45" viewBox="0 -960 960 960" width="45" fill="currentColor"><path d="M200-520q-33 0-56.5-23.5T120-600v-160q0-33 23.5-56.5T200-840h560q33 0 56.5 23.5T840-760v160q0 33-23.5 56.5T760-520H200Zm0-80h560v-160H200v160Zm0 480q-33 0-56.5-23.5T120-200v-160q0-33 23.5-56.5T200-440h560q33 0 56.5 23.5T840-360v160q0 33-23.5 56.5T760-120H200Zm0-80h560v-160H200v160Zm0-400v-160 160Zm0 400v-160 160Z"/></svg>`,content:` <section id="sections_041825_f" class="flex flex-row relative min-h-[100vh] max-[852px]:flex-col">
  ...
  </section> `},{id:"section_042125_g",label:"section - g",category:"section",media:`
<svg xmlns="http://www.w3.org/2000/svg" height="45" viewBox="0 -960 960 960" width="45" fill="currentColor"><path d="M200-520q-33 0-56.5-23.5T120-600v-160q0-33 23.5-56.5T200-840h560q33 0 56.5 23.5T840-760v160q0 33-23.5 56.5T760-520H200Zm0-80h560v-160H200v160Zm0 480q-33 0-56.5-23.5T120-200v-160q0-33 23.5-56.5T200-440h560q33 0 56.5 23.5T840-360v160q0 33-23.5 56.5T760-120H200Zm0-80h560v-160H200v160Zm0-400v-160 160Zm0 400v-160 160Z"/></svg>`,content:`     <section id="sections_041825_g" class="flex flex-col p-[10px] min-h-[100vh] max-[600px]:flex-col-reverse">
...
</section> `},{id:"section_042125_h",label:"section - h",category:"section",media:`
<svg xmlns="http://www.w3.org/2000/svg" height="45" viewBox="0 -960 960 960" width="45" fill="currentColor"><path d="M200-520q-33 0-56.5-23.5T120-600v-160q0-33 23.5-56.5T200-840h560q33 0 56.5 23.5T840-760v160q0 33-23.5 56.5T760-520H200Zm0-80h560v-160H200v160Zm0 480q-33 0-56.5-23.5T120-200v-160q0-33 23.5-56.5T200-440h560q33 0 56.5 23.5T840-360v160q0 33-23.5 56.5T760-120H200Zm0-80h560v-160H200v160Zm0-400v-160 160Zm0 400v-160 160Z"/></svg>`,content:` <section id="sections_041825_h" class="flex flex-row min-h-[100vh] p-[10px] max-[768px]:flex-col">
...
</section> `},{id:"section_042125_i",label:"section - i",category:"section",media:`
<svg xmlns="http://www.w3.org/2000/svg" height="45" viewBox="0 -960 960 960" width="45" fill="currentColor"><path d="M200-520q-33 0-56.5-23.5T120-600v-160q0-33 23.5-56.5T200-840h560q33 0 56.5 23.5T840-760v160q0 33-23.5 56.5T760-520H200Zm0-80h560v-160H200v160Zm0 480q-33 0-56.5-23.5T120-200v-160q0-33 23.5-56.5T200-440h560q33 0 56.5 23.5T840-360v160q0 33-23.5 56.5T760-120H200Zm0-80h560v-160H200v160Zm0-400v-160 160Zm0 400v-160 160Z"/></svg>`,content:` <section id="sections_041825_i" class="flex flex-row p-[20px] min-h-screen max-[876px]:flex-col">
...
</section> `}];let m;function r(){clearTimeout(m),m=setTimeout(()=>{document.getElementById("popupdialog").style.display="block"},6e4)}document.addEventListener("mousemove",r);r();document.getElementById("popupclosediag").addEventListener("click",()=>{document.getElementById("popupdialog").style.display="none",r()});let d="script";GrapesJsStudioSDK.createStudioEditor({root:"#studio",blocks:{default:u()},layout:{default:{type:"row",style:{height:"100%"},children:[{type:"sidebarLeft",children:{type:"tabs",value:"blocks",tabs:[{id:"pages",label:"🗃️",children:{media:'<svg xmlns="http://www.w3.org/2000/svg" height="40px" viewBox="0 -960 960 960" width="40px" fill="#e8eaed"><path d="M560-440h200v-80H560v80Zm0-120h200v-80H560v80ZM200-320h320v-22q0-45-44-71.5T360-440q-72 0-116 26.5T200-342v22Zm160-160q33 0 56.5-23.5T440-560q0-33-23.5-56.5T360-640q-33 0-56.5 23.5T280-560q0 33 23.5 56.5T360-480ZM160-160q-33 0-56.5-23.5T80-240v-480q0-33 23.5-56.5T160-800h640q33 0 56.5 23.5T880-720v480q0 33-23.5 56.5T800-160H160Zm0-80h640v-480H160v480Zm0 0v-480 480Z"/></svg>',type:"panelPages",style:{height:"100%"}}},{id:"layers",label:"⚙️",children:{type:"panelLayers",style:{height:"100%"}}},{id:"blocks",label:"🧩",children:{type:"panelBlocks",style:{height:"100%"}}},{id:"template",label:"🎨",children:{type:"panelTemplates",style:{height:"100%",padding:"20px 5px"},content:{itemsPerRow:1}}}]}},{type:"canvasSidebarTop",sidebarTop:{leftContainer:{buttons:[]}}},{type:"sidebarRight",children:{type:"tabs",value:"styles",tabs:[{id:"styles",label:"Styles",children:{type:"column",style:{height:"100%"},children:[{type:"panelSelectors",style:{padding:5}},{type:"panelStyles"}]}},{id:"props",label:"Properties",children:{type:"panelProperties",style:{padding:5,height:"100%"}}},{id:"custom",label:"Custom",children:["New custom tab"]}]}}]}},templates:{layout:{type:"panelTemplates",content:{itemsPerRow:2}},onLoad:async()=>[{id:"template1",name:"Template 1",data:{pages:[{name:"Home",component:'<h1 class="title">Template 1</h1><style>.title { color: red; font-size: 10rem; text-align: center }</style>'},{name:"About",component:'<h1 class="title">Template 1</h1><style>.title { color: red; font-size: 10rem; text-align: center }</style>'}]}},{id:"template2",name:"Template 2",data:{pages:[{component:'<h1 class="title">Template 2</h1><style>.title { color: blue; font-size: 10rem; text-align: center }</style>'}]}},{id:"template3",name:"Template 3",data:{pages:[{component:'<h1 class="title">Template 3</h1><style>.title { color: green; font-size: 10rem; text-align: center }</style>'}]}},{id:"template4",name:"Template 4",data:{pages:[{component:'<h1 class="title">Template 4</h1><style>.title { color: violet; font-size: 10rem; text-align: center }</style>'}]}}]},project:{type:"web",default:{custom:{globalPageSettings:{generator:"FlexBoy Studio",title:"FlexBoy Web Design",description:"FlexBoy description",customCodeHead:`
<link href="https://cdn.jsdelivr.net/npm/daisyui@5" rel="stylesheet" type="text/css" />
<${d} src="https://cdn.jsdelivr.net/npm/@tailwindcss/browser@4"></${d}>
...
<link href="https://flexboy.vercel.app/public_temp/mytemps.css" rel="stylesheet" type="text/css" />
          ...
          </h1>`,styles:"#comp3 { color: blue }"}]}}});$(document).on("click","#viewbuilder",()=>{$("#home").hide(),$("#bmc-wbtn").hide(),$("#builder").css({display:"flex"})});$(document).on("click","#backhome",()=>{$("#home").show(),$("#bmc-wbtn").show(),$("#builder").hide(),$("html, body").animate({scrollTop:0})});const e=document.querySelector(".scroll-loop-container");let l=!1,c,n;e.addEventListener("mousedown",s=>{l=!0,e.classList.add("active"),c=s.pageX-e.offsetLeft,n=e.scrollLeft});e.addEventListener("mouseleave",()=>{l=!1,e.classList.remove("active")});e.addEventListener("mouseup",()=>{l=!1,e.classList.remove("active")});e.addEventListener("mousemove",s=>{if(!l)return;s.preventDefault();const o=(s.pageX-e.offsetLeft-c)*1.5;e.scrollLeft=n-o});e.addEventListener("touchstart",s=>{l=!0,c=s.touches[0].pageX-e.offsetLeft,n=e.scrollLeft});e.addEventListener("touchend",()=>{l=!1});e.addEventListener("touchmove",s=>{if(!l)return;const o=(s.touches[0].pageX-e.offsetLeft-c)*1.5;e.scrollLeft=n-o});window.addEventListener("load",function(){window.location.hash==="#builder"&&($("#home").hide(),$("#bmc-wbtn").hide(),$("#builder").css({display:"flex"}))});function f(){return document.fullscreenElement||document.webkitFullscreenElement||document.mozFullScreenElement||document.msFullscreenElement}f()?$("#jdh38d").hide():$("#jdh38d").show();document.addEventListener("fullscreenchange",function(){f()?$("#jdh38d").hide():$("#jdh38d").show()});$(document).on("click","#disqusms",function(){$("#disquschat").removeClass("slide-out").show().addClass("slide-in")});$(document).on("click","#viewchats",function(){$("#disquschat").removeClass("slide-out").show().addClass("slide-in")});$(document).on("click","#closechat",function(){const s=$("#disquschat");s.removeClass("slide-in").addClass("slide-out"),setTimeout(()=>{s.hide()},300)});
