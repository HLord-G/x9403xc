...
<menu class="phone_menu fixed hidden flex-col justify-start items-center top-0 left-0 w-full h-full z-[99] bg-base-300 max-[780px]:flex" style="transform: translateX(-999px);">

    <button class="absolute top-[4%] right-[6%] closemenu">
    ...
    <main class="flex flex-col justify-start mt-[30%] items-center">
    ...
    <div class="absolute bottom-[5%] left-[7%]">
        <div class="flex flex-row gap-[15px] justify-center items-center icon">
...
<nav class="px-[40px] fixed top-[7%] z-[8] left-0 flex w-full flex-row justify-between items-center max-[490px]:px-[10px] max-[780px]:top-[3%]">
    ...
    <button class="hidden flex-row justify-end items-center openmenu max-[780px]:flex">
...
<section class="min-h-[120vh] relative">
...
<section class="p-[20px] flex flex-col justify-center items-center max-[549px]:p-[0px]">
...
<section class="p-[20px] flex flex-col justify-center items-center overflow-hidden">
...
<section class="min-h-[10vh] flex justify-center items-center flex-col bg-base-300">
...
<section class="flex flex-col justify-center items-center my-[30px]">
    <div class="my-[40px]">
...
<section class="flex flex-col justify-center items-center my-[80px]">
...
<footer class="p-[20px] w-full flex flex-row justify-center items-center bg-base-300">
